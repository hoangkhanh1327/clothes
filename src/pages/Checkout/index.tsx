...
import {
    AddressForm,
    AddressSelector,
} from '../../modules/common/components/Checkout';
...
const Checkout: NextPageWithLayout = () => {
    ...
    const [addressModalVisibility, setAddressModalVisibility] =
            ...
            items.reduce((accumulator, currentItem) => {
                return (
                    ...
                    (currentItem.discount_percent
                        ? currentItem.price * currentItem.discount_percent
                        : 0)
                );
            }, 0);
        }
    ...
    return (
        <div className='tw-container'>
            ...
            />
            <Row
                className='tw-shadow-md tw-pt-7 tw-pb-6 tw-px-[30px]'
                gutter={[20, 20]}
            >
                <Col span={24}>
                    <Title
                        className='tw-capitalize !tw-text-primary !tw-text-lg !tw-mb-0'
                        level={3}
                    >
                        <FontAwesomeIcon
                            icon={faMapMarkerAlt}
            ...
            <Row
                className='tw-shadow-md tw-pt-7 tw-pb-6 tw-px-[30px] tw-mt-3'
                gutter={[20, 20]}
            >
                <Col span={24}>
                    <Title
                ...
                <Col span={24}>
                    ...
                    >
                        <Space direction='vertical'>
                            ...
                            <Radio value={'zalopay'}>
                                ZaloPay - Thanh toán thông qua kênh ZaloPay
                            </Radio>
                        </Space>
                    </Radio.Group>
                </Col>
                <Col span={6} offset={18} className=''>
                    <Space direction='vertical'>
                        <div className='tw-grid tw-grid-cols-2'>
                            <Text className='tw-capitalize tw-text-base tw-text-secondary'>
                                Tổng tiền hàng:
                            </Text>
                            <Text className='tw-text-right tw-text-base tw-text-secondary tw-font-bold'>
                                {totalProductPrice} VNĐ
                            </Text>
                        </div>
                        <div className='tw-grid tw-grid-cols-2'>
                            <Text className='tw-capitalize tw-text-base tw-text-secondary'>
                        ...
                        <div className='tw-grid tw-grid-cols-2'>
                            <Text className='tw-text-lg tw-text-secondary tw-font-bold'>
                                Tổng thanh toán
                            </Text>
            ...
            <AddressSelector
                ...
                onConfirm={(value: number | string) => {
                    setCurrentAddress(
                        address.find((address) => address.id === value)
                    );
                    setAddressModalVisibility(false);
                }}
            />
